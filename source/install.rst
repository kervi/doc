...
If you install Kervi on other platforms like windows and linux you have to install python and pip. Please follow the instructions on python.org to get python installed. 
...
To create a full kervi application write the following command in the terminal::
    ...
    kervi create application my_app "My first app"
